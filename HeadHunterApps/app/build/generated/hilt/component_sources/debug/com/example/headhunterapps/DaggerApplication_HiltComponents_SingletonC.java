...
import com.example.headhunterapp.data.repository.RepositoryModule_ProvideRepositoryFactory;
import com.example.headhunterapps.presentation.MainActivity;
import com.example.headhunterapps.presentation.entryfragment.EntryEmailFragment;
import com.example.headhunterapps.presentation.entryfragment.EntryPasswordFragment;
import com.example.headhunterapps.presentation.favourite.FavoritesFragment;
import com.example.headhunterapps.presentation.homefragment.HomeFragment;
import com.example.headhunterapps.presentation.homefragment.HomeFragment_MembersInjector;
import com.example.headhunterapps.presentation.massage.MassageFragment;
import com.example.headhunterapps.presentation.response.ResponseFragment;
import com.example.headhunterapps.presentation.vacancy.VacancyAllFragment;
...
public final class DaggerApplication_HiltComponents_SingletonC {
  ...
  private static final class FragmentCImpl extends Application_HiltComponents.FragmentC {
    ...
    @Override
    public void injectEntryEmailFragment(EntryEmailFragment entryEmailFragment) {
    }

    @Override
    public void injectEntryPasswordFragment(EntryPasswordFragment entryPasswordFragment) {
    }
    ...
    @Override
    public void injectMassageFragment(MassageFragment massageFragment) {
    }
    ...
    @Override
    public void injectVacancyAllFragment(VacancyAllFragment vacancyAllFragment) {
    }
    ...
    private HomeFragment injectHomeFragment2(HomeFragment instance) {
      HomeFragment_MembersInjector.injectRepository(instance, singletonCImpl.provideRepositoryProvider.get());
      return instance;
    }
  }
  ...
  private static final class ActivityCImpl extends Application_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_example_headhunterapps_ViewModel, ViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_example_headhunterapps_ViewModel = "com.example.headhunterapps.ViewModel";

      @KeepFieldType
      ViewModel com_example_headhunterapps_ViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends Application_HiltComponents.ViewModelC {
    ...
    @Override
    public Map<Class<?>, javax.inject.Provider<androidx.lifecycle.ViewModel>> getHiltViewModelMap(
        ) {
      return LazyClassKeyMap.<javax.inject.Provider<androidx.lifecycle.ViewModel>>of(Collections.<String, javax.inject.Provider<androidx.lifecycle.ViewModel>>singletonMap(LazyClassKeyProvider.com_example_headhunterapps_ViewModel, ((Provider) viewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.headhunterapps.ViewModel 
          return (T) new ViewModel(singletonCImpl.userDao(), singletonCImpl.provideRepositoryProvider.get());
  ...
  private static final class SingletonCImpl extends Application_HiltComponents.SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.headhunterapp.data.repository.Repository 
          return (T) RepositoryModule_ProvideRepositoryFactory.provideRepository(singletonCImpl.userDao());

          case 1: // com.example.headhunterapp.data.db.AppDataBase 
