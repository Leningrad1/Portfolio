 ...
 */
public abstract class Hilt_MassageFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MassageFragment() {
    super();
  }

  Hilt_MassageFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MassageFragment_GeneratedInjector) this.generatedComponent()).injectMassageFragment(UnsafeCasts.<MassageFragment>unsafeCast(this));
    }
  }
