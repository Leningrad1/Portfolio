 ...
 */
public abstract class Hilt_ResponseFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ResponseFragment() {
    super();
  }

  Hilt_ResponseFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ResponseFragment_GeneratedInjector) this.generatedComponent()).injectResponseFragment(UnsafeCasts.<ResponseFragment>unsafeCast(this));
    }
  }
