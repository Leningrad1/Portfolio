 ...
 */
public abstract class Hilt_VacancyAllFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VacancyAllFragment() {
    super();
  }

  Hilt_VacancyAllFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VacancyAllFragment_GeneratedInjector) this.generatedComponent()).injectVacancyAllFragment(UnsafeCasts.<VacancyAllFragment>unsafeCast(this));
    }
  }
