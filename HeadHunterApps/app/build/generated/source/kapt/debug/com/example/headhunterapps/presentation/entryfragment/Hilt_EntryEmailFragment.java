 ...
 */
public abstract class Hilt_EntryEmailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EntryEmailFragment() {
    super();
  }

  Hilt_EntryEmailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EntryEmailFragment_GeneratedInjector) this.generatedComponent()).injectEntryEmailFragment(UnsafeCasts.<EntryEmailFragment>unsafeCast(this));
    }
  }
