 ...
 */
public abstract class Hilt_EntryPasswordFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EntryPasswordFragment() {
    super();
  }

  Hilt_EntryPasswordFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EntryPasswordFragment_GeneratedInjector) this.generatedComponent()).injectEntryPasswordFragment(UnsafeCasts.<EntryPasswordFragment>unsafeCast(this));
    }
  }
