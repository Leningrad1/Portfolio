...
class ImageSlidePostAdapter(private val context: Context, private var imageListPost: MutableList<ItemPost>?) : PagerAdapter() {
    override fun getCount(): Int {
        return imageListPost!!.size
    }
